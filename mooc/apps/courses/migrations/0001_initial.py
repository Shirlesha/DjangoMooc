    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.SchoolName', verbose_name='所属机构')),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.Lecturer', verbose_name='讲师')),
            ],
            options={
                'verbose_name': '课程',
